      ...
      <div className="mx-auto w-full max-w-sm">
        <div className="rounded-2xl border border-zinc-100 bg-white p-8 shadow-sm">
          ...
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-zinc-200 bg-white px-4 py-3 text-[14px] font-medium text-zinc-700 shadow-sm transition-all active:scale-[0.98] disabled:opacity-50"
          >
            {loading ? (
          ...
          {error && (
            <p className="mt-4 text-center text-[13px] text-red-500">
              Zugriff verweigert. Nur der autorisierte Benutzer kann sich anmelden.
            </p>
          )}
        </div>
