...
/* ─── Animation phases ───
   0  pure black
   1  ambient glow appears
   2  logo fades in + scales
   3  brand name reveals
   4  subtitle reveals
   5  splash dissolving → auth appearing
   6  splash unmounted, auth live
────────────────────────── */

export default function LoginPage() {
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState(false);
  const [p, setP] = useState(0); // phase

  /* Dark theme-color for mobile status bar */
  useEffect(() => {
  ...
  useEffect(() => {
    const t = [
      ...
      setTimeout(() => setP(2), 380),
      setTimeout(() => setP(3), 920),
      setTimeout(() => setP(4), 1320),
      setTimeout(() => setP(5), 1880),
      setTimeout(() => setP(6), 2480),
    ];
  ...
  return (
    <div className="fixed inset-0 bg-[#060607]">
      ...
      {p < 6 && (
        ...
        >
          {/* Ambient center corona */}
          <div
            className="pointer-events-none absolute left-1/2 top-1/2 h-[280px] w-[280px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#b8860b]/[0.045] blur-[100px]"
            style={{
              opacity: p >= 1 ? 1 : 0,
              transform: `translate(-50%,-50%) scale(${p >= 1 ? 1 : 0.7})`,
          ...
          <div
            className="pointer-events-none absolute left-1/2 top-[48%] h-[500px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#b8860b]/[0.015] blur-[180px]"
            style={{
              opacity: p >= 2 ? 1 : 0,
          ...
          <div className="flex flex-col items-center">
            ...
            <div
              style={{
                opacity: p >= 2 ? 1 : 0,
                transform: `scale(${p >= 2 ? 1 : 0.8})`,
                transition: "opacity 650ms cubic-bezier(0.16, 1, 0.3, 1), transform 650ms cubic-bezier(0.16, 1, 0.3, 1)",
              }}
            >
              <div className="relative">
                <div className="absolute -inset-8 rounded-full bg-[#b8860b]/[0.06] blur-2xl" />
                <div className="relative flex h-[72px] w-[72px] items-center justify-center rounded-[20px] border border-white/[0.06] bg-white/[0.03]">
                  <svg width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" className="text-[#c9a84c]">
            ...
            <div
              ...
              style={{
                opacity: p >= 3 ? 1 : 0,
                transform: `translateY(${p >= 3 ? 0 : 10}px)`,
                transition: "opacity 550ms ease-out, transform 550ms cubic-bezier(0.16, 1, 0.3, 1)",
              }}
            >
              <h1 className="text-[34px] font-light tracking-[0.08em] text-white">
                Mgrdegh
              </h1>
            </div>
            ...
            <div
              ...
              style={{
                opacity: p >= 4 ? 1 : 0,
                transform: `translateY(${p >= 4 ? 0 : 6}px)`,
                transition: "opacity 450ms ease-out, transform 450ms ease-out",
              }}
            >
              <div className="flex items-center gap-4">
                <span className="h-px w-10 bg-gradient-to-r from-transparent via-white/[0.1] to-transparent" />
      ...
      >
        ...
        <div className="relative z-10 flex w-full max-w-[340px] flex-col items-center">
          ...
          {/* Brand mark — staggered entrance */}
          <div
            className="relative mb-16"
            style={{
              opacity: p >= 5 ? 1 : 0,
              transform: `translateY(${p >= 5 ? 0 : 16}px)`,
              transition: "opacity 600ms ease-out, transform 600ms cubic-bezier(0.16, 1, 0.3, 1)",
              transitionDelay: p >= 5 ? "200ms" : "0ms",
            }}
          >
          ...
          <div
            ...
            style={{
              opacity: p >= 5 ? 1 : 0,
              transform: `translateY(${p >= 5 ? 0 : 20}px)`,
              transition: "opacity 600ms ease-out, transform 600ms cubic-bezier(0.16, 1, 0.3, 1)",
              transitionDelay: p >= 5 ? "440ms" : "0ms",
            }}
          >
