  ...
  return (
    <div className="space-y-6 lg:space-y-7 animate-fade-in">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        ...
        <Link href="/products"
          className="group flex flex-col rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 p-5 transition-all duration-300 hover:shadow-lg hover:shadow-zinc-100 hover:-translate-y-0.5 active:scale-[0.98] sm:col-span-2 lg:p-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-zinc-100 dark:bg-zinc-700">
              <Gem size={14} className="text-zinc-500 dark:text-zinc-400" />
            </div>
          </div>
          <p className="mt-3 text-2xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 lg:text-3xl">{formatCurrency(kpis.expectedSalesValue)}</p>
                ...
                return (
                  <div key={b.brand}>
                    <div className="mb-1 flex items-center justify-between gap-2">
                      <span className="truncate text-[11px] font-semibold text-zinc-700 dark:text-zinc-300 max-w-[45%]">{b.brand}</span>
                    ...
                    <div className="h-1 w-full overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-700">
                      <div
                        className="h-full rounded-full bg-zinc-300 dark:bg-zinc-500 transition-all"
                    ...
                    <div className="mt-1 flex gap-2">
                      ...
                      <span className="text-[10px] text-zinc-400">
                        <span className="font-semibold text-zinc-700 dark:text-zinc-300">{b.stock}</span> im Bestand
                      </span>
                      {soldPct > 0 && (
                        <>
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        <Link href="/products"
          className="group flex items-center gap-3 rounded-xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 px-4 py-3.5 transition-all hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98]">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-zinc-100 dark:bg-zinc-700 transition-colors group-hover:bg-zinc-900 dark:group-hover:bg-zinc-600">
            <Package size={16} className="text-zinc-600 dark:text-zinc-400 group-hover:text-white transition-colors" />
          </div>
          <div>
            <p className="text-[18px] font-bold leading-none text-zinc-900 dark:text-zinc-100">{formatNumber(kpis.totalProducts)}</p>
        ...
        <Link href="/products"
          className="group flex items-center gap-3 rounded-xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 px-4 py-3.5 transition-all hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98]">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/25 transition-colors group-hover:bg-blue-600">
            <Warehouse size={16} className="text-blue-500 group-hover:text-white transition-colors" />
          </div>
          <div>
            <p className="text-[18px] font-bold leading-none text-zinc-900 dark:text-zinc-100">{formatNumber(kpis.totalStock)}</p>
        ...
        <Link href="/products"
          className={cn(
            ...
            kpis.lowStockItems > 0 ? "border-amber-100 dark:border-amber-800/30 bg-amber-50/60 dark:bg-amber-900/15" : "border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60"
          )}>
          <div className={cn("flex h-9 w-9 shrink-0 items-center justify-center rounded-lg transition-colors",
            kpis.lowStockItems > 0 ? "bg-amber-100 dark:bg-amber-900/30 group-hover:bg-amber-500" : "bg-zinc-100 dark:bg-zinc-700 group-hover:bg-zinc-900")}>
            <AlertTriangle size={16} className={cn("transition-colors", kpis.lowStockItems > 0 ? "text-amber-600 group-hover:text-white" : "text-zinc-500 dark:text-zinc-400 group-hover:text-white")} />
          </div>
          <div>
            <p className={cn("text-[18px] font-bold leading-none", kpis.lowStockItems > 0 ? "text-amber-700 dark:text-amber-400" : "text-zinc-900 dark:text-zinc-100")}>{formatNumber(kpis.lowStockItems)}</p>
        ...
        <Link href="/products"
          className={cn(
            "group flex items-center gap-3 rounded-xl border px-4 py-3.5 transition-all hover:shadow-md hover:-translate-y-0.5 active:scale-[0.98]",
            kpis.outOfStockItems > 0 ? "border-red-100 dark:border-red-800/30 bg-red-50/60 dark:bg-red-900/15" : "border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60"
          )}>
          <div className={cn("flex h-9 w-9 shrink-0 items-center justify-center rounded-lg transition-colors",
            kpis.outOfStockItems > 0 ? "bg-red-100 dark:bg-red-900/30 group-hover:bg-red-500" : "bg-zinc-100 dark:bg-zinc-700 group-hover:bg-zinc-900")}>
            <XCircle size={16} className={cn("transition-colors", kpis.outOfStockItems > 0 ? "text-red-500 group-hover:text-white" : "text-zinc-500 dark:text-zinc-400 group-hover:text-white")} />
          </div>
          <div>
            <p className={cn("text-[18px] font-bold leading-none", kpis.outOfStockItems > 0 ? "text-red-600 dark:text-red-400" : "text-zinc-900 dark:text-zinc-100")}>{formatNumber(kpis.outOfStockItems)}</p>
      ...
      {charts.salesOverTime.length > 0 && (
        <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 p-5 shadow-sm lg:p-7">
          <div className="mb-5 flex items-start justify-between lg:mb-7">
            <div>
              <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100 lg:text-base">Umsatzverlauf</h3>
            ...
            <div className="flex items-center gap-5">
              ...
              <Link href="/reports" className="rounded-lg bg-zinc-100 dark:bg-zinc-700 px-3 py-1.5 text-[11px] font-semibold text-zinc-600 dark:text-zinc-300 transition hover:bg-zinc-200 dark:hover:bg-zinc-600">
                Details →
              </Link>
            </div>
          </div>
      ...
      {(charts.topBrands.length > 0 || charts.topProducts.length > 0) && (
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          {charts.topBrands.length > 0 && (
            <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 p-5 shadow-sm lg:p-6">
              <h3 className="mb-1 text-sm font-bold text-zinc-900 dark:text-zinc-100">Top Marken</h3>
          ...
          {charts.topProducts.length > 0 && (
            <div className="rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 p-5 shadow-sm lg:p-6">
              <h3 className="mb-1 text-sm font-bold text-zinc-900 dark:text-zinc-100">Meistverkauft</h3>
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <div>
          <div className="mb-3 flex items-center justify-between">
            <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Letzte Verkäufe</h3>
            <Link href="/sales" className="rounded-lg bg-zinc-100 dark:bg-zinc-800 px-3 py-1.5 text-[11px] font-semibold text-zinc-600 dark:text-zinc-400 transition hover:bg-zinc-200 dark:hover:bg-zinc-700">
              Alle →
            </Link>
          </div>
          {recentSales.length === 0 ? (
            <div className="flex flex-col items-center justify-center rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 py-14 text-center shadow-sm">
              <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-zinc-100 dark:bg-zinc-700">
                <ShoppingBag size={20} className="text-zinc-400" />
              </div>
              <p className="text-[12px] text-zinc-400">Noch keine Verkäufe</p>
            </div>
          ) : (
            <div className="overflow-hidden rounded-2xl border border-zinc-100 dark:border-zinc-800/50 bg-white dark:bg-zinc-800/60 shadow-sm divide-y divide-zinc-50 dark:divide-zinc-700/50">
              {recentSales.map((sale) => (
                <Link key={sale.id} href={sale.productId ? `/products/${sale.productId}` : "/sales"}
                  className="group flex items-center gap-3.5 px-4 py-3.5 transition-colors hover:bg-zinc-50/80 dark:hover:bg-zinc-700/40 active:bg-zinc-100 dark:active:bg-zinc-700">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-emerald-50 dark:bg-emerald-900/20 transition-colors group-hover:bg-emerald-100 dark:group-hover:bg-emerald-900/30">
                    <ArrowUpRight size={15} className="text-emerald-600" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="truncate text-[13px] font-semibold text-zinc-900 dark:text-zinc-100">{sale.product.name}</p>
                    <p className="mt-0.5 text-[11px] text-zinc-400">{sale.product.brand}{sale.customerName && ` · ${sale.customerName}`}</p>
                  </div>
                  <div className="shrink-0 text-right">
                    <p className="text-[13px] font-bold text-zinc-900 dark:text-zinc-100">+{formatCurrency(sale.totalAmount)}</p>
        ...
        {alerts.length > 0 && (
          <div>
            <div className="mb-3 flex items-center justify-between">
              <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100">Bestandswarnungen</h3>
